...
;-
	...
	tem.amu = 1d-3
        tem.gra = 1d-3*tem.gra
        tem.mp  = 1d-3*tem.mp
        tem.au  = 1d-2*tem.au
        tem.parsec = 1d-2*tem.parsec
        tem.msun = 1d-3*tem.msun
        tem.rsun = 1d-2*tem.rsun
        tem.lsun = 1d-7*tem.lsun
    endif
