...
c       changes 06.09.2017 - 03.10.2017 - Jordan Joe Thirlwall (JJT)
c       Corrected a(x,y,z) and eta(x,y,z) to set negative values to 0
c       Added 4 extra disks, 2 dust, 2 stellar
c       March 2018 - JJT:
c       Decoupled the truncation radii of the dust and stellar disks.
c       August 2018 - added nuclear disk component for M33

        Subroutine NUdust(mask,dzmodel,morph,filter,diag_plots)
c----------------------------------------------------------------------------
...
c        parameter (nsizeu=30000)
        ...
        integer mask(nsize),maskcalc(nsize),diag_plots

        character*80 morph,filter
...
ccc JJT 26 Sep 17 Common blocks ccc
...
c dust.urad common JJT 19FEB19
     ...
     >  uout(nsizeu),faout(nsizeu)
            common/diag/prof_lim
c            common/diag/diag_plots
...
c	if(idust .ne. 0)open (unit=4, file='dust.plo')
...
c inner extra disk
        ...
        hd3in=hd3in/pix2kpc
        zd3in = zd3in/pix2kpc
        hd3solar = hd3solar/pix2kpc
        zd3solar = zd3solar/pix2kpc
        hd4in=hd4in/pix2kpc
        zd4in = zd4in/pix2kpc
        hd4solar = hd4solar/pix2kpc
        zd4solar = zd4solar/pix2kpc
	     hs3=hs3/pix2kpc
	     zs3=zs3/pix2kpc
	     hs4=hs4/pix2kpc
	     zs4=zs4/pix2kpc
        hs3in=hs3in/pix2kpc
        zs3in = zs3in/pix2kpc
        hs3solar = hs3solar/pix2kpc
        zs3solar = zs3solar/pix2kpc
        hs4in=hs4in/pix2kpc
        zs4in = zs4in/pix2kpc
        hs4solar = hs4solar/pix2kpc
        zs4solar = zs4solar/pix2kpc
...
c outter extra disk
        ...
        hd5in=hd5in/pix2kpc
        zd5in = zd5in/pix2kpc
        hd5solar = hd5solar/pix2kpc
        zd5solar = zd5solar/pix2kpc
        hd6in=hd6in/pix2kpc
        zd6in = zd6in/pix2kpc
        hd6solar = hd6solar/pix2kpc
        zd6solar = zd6solar/pix2kpc
	     hs5=hs5/pix2kpc
	     zs5=zs5/pix2kpc
	     hs6=hs6/pix2kpc
	     zs6=zs6/pix2kpc
        hs5in=hs5in/pix2kpc
        zs5in = zs5in/pix2kpc
        hs5solar = hs5solar/pix2kpc
        zs5solar = zs5solar/pix2kpc
        hs6in=hs6in/pix2kpc
        zs6in = zs6in/pix2kpc
        hs6solar = hs6solar/pix2kpc
        zs6solar = zs6solar/pix2kpc

c nuclear extra disk 3 Aug 18 JJT
c        print*,'hs7'
c        print*,hs7
	     hs7=hs7/pix2kpc
c        print*,'hs7'
...
c        print*,zs7
        hs7in=hs7in/pix2kpc
        zs7in = zs7in/pix2kpc
        hs7solar = hs7solar/pix2kpc
        zs7solar = zs7solar/pix2kpc

c extra truncations
        rtrun3=rtruncate3/pix2kpc
        rtrun4=rtruncate4/pix2kpc
        rtrun5=rtruncate5/pix2kpc
        rtrun6=rtruncate6/pix2kpc
        rtrun7=rtruncate7/pix2kpc

c dust truncations 14MAR18 - JJT
        rtrund=rtruncated/pix2kpc
        rtrund1=rtruncated1/pix2kpc
        rtrund3=rtruncated3/pix2kpc
        rtrund4=rtruncated4/pix2kpc
        rtrund5=rtruncated5/pix2kpc
        rtrund6=rtruncated6/pix2kpc
c inner truncations
         hstin=hstin/pix2kpc
         hdtin=hdtin/pix2kpc
         hs1tin=hs1tin/pix2kpc
         hd1tin=hd1tin/pix2kpc
         hs3tin=hs3tin/pix2kpc
         hd3tin=hd3tin/pix2kpc
         hs4tin=hs4tin/pix2kpc
         hd4tin=hd4tin/pix2kpc
         hs5tin=hs5tin/pix2kpc
         hd5tin=hd5tin/pix2kpc
         hs6tin=hs6tin/pix2kpc
         hd6tin=hd6tin/pix2kpc
         hs7tin=hs7tin/pix2kpc


ccc JJT 28 September 17 end ccc
c        write(6,3699)rtrun,rtruncate
c 3699     format(1h ,'***** rtrun,rtruncate = ',2e12.3)
c        sha=sharp/pix2kpc
c        sha1=sharp1/pix2kpc
        sha=sharp
        sha1=sharp1
ccc JJT 28 Spetember 17 ccc
        sha3=sharp3
        sha4=sharp4
        sha5=sharp5
        sha6=sharp6 
        sha7=sharp7 
ccc JJT 28 September 17 end ccc
c Sharp parameters for dust components - 14MAR18 JJT
        shad=sharpd
        shad1=sharpd1
        shad3=sharpd3
        shad4=sharpd4
...
c        if(iurad .eq. 2)zu=zu/pix2kpc
 ...
 791   continue
	...
	tau0=tau0*hd/zd
        tau1=tau1*hd1/zd1
ccc JJT 28 September 2017 ccc
c Tau index is 1 more than hd/zd index
c this is to leave tau2 as the value for the
c elliptical model
         tau3=tau3*hd3/zd3
         tau4=tau4*hd4/zd4
         tau5=tau5*hd5/zd5
         tau6=tau6*hd6/zd6
ccc end JJT 28 September 2017 ccc
...
ccc JJT 28 September 2017 ccc
c inner disk
        eta3=(10.**(-eta3/2.5))*pixsize2
        eta3=eta3*bin2/(2.d0*zs3*bfactor)
c inner tdisk
        eta4=(10.**(-eta4/2.5))*pixsize2
        eta4=eta4*bin2/(2.d0*zs4*bfactor)
c outer disk
        eta5=(10.**(-eta5/2.5))*pixsize2
        eta5=eta5*bin2/(2.d0*zs5*bfactor)
c outer tdisk
         print*,'eta6'
         print*,eta6
        eta6=(10.**(-eta6/2.5))*pixsize2
        eta6=eta6*bin2/(2.d0*zs6*bfactor)
         print*,'eta6'
         print*,eta6
ccc JJT 28 September 2017 ccc
c nuclear tdisk 3 Aug 18
         print*,'eta7'
         print*,eta7
        eta7=(10.**(-eta7/2.5))*pixsize2
        eta7=eta7*bin2/(2.d0*zs7*bfactor)
         print*,'eta7'
         print*,eta7
c         write(6,*)'eta6'
c         write(6,*) eta6
...
cJJT 30OCT18
	if(ifilter.eq.16) then
c       IRAC channel 1 3.4um 
c       Jy for zero magnitude
c          IRAC instrument handbook table4.1
           szero=280.9
           c1=1.0d0/(bfactor*szero)
           ufactor=ufactor/c1
	endif
	if(ifilter.eq.17) then
c       IRAC channel 2 4.5um 
c       Jy for zero magnitude
c          IRAC instrument handbook table4.1
           szero=179.7
           c1=1.0d0/(bfactor*szero)
	...
	if(ifilter.eq.18) then
c       IRAC channel 3 5.8um 
c       Jy for zero magnitude
c          IRAC instrument handbook table4.1
           szero=115.0
           c1=1.0d0/(bfactor*szero)
...
c
        a3=0.0d0
c inner disk
        if(idisk3 .eq. 1)a3= tau3/ (2.0d0* hd3)
        if(idisk3 .eq. 3)a3= tau3/ (2.0d0* hd3)
c inner tdisk
        a4=0.0d0
        if(idisk4 .eq. 1)a4= tau4/ (2.0d0* hd4)
        if(idisk4 .eq. 3)a4= tau4/ (2.0d0* hd4)
c outer disk
        a5=0.0d0
        if(idisk5 .eq. 1)a5= tau5/ (2.0d0* hd5)
        if(idisk5 .eq. 3)a5= tau5/ (2.0d0* hd5)
c outer tdisk 
        a6=0.0d0
        if(idisk6 .eq. 1)a6= tau6/ (2.0d0* hd6)
        if(idisk6 .eq. 3)a6= tau6/ (2.0d0* hd6)
ccc JJT 28 September 2017 ccc
...
c        print*,diag_plots
       if (diag_plots .eq. 1) then

        print*, 'HELLO'
        print*, morph(1:lenmorph)
        print*, lenmorph
        if (morph(1:lenmorph) .eq. 'b') then
        call plot_etabulger(morph(1:lenmorph),filter(1:lenfilter))
        call plot_etabulgez(morph(1:lenmorph),filter(1:lenfilter))
        endif
        if  (morph(1:lenmorph) .eq. 'd') then 
         call plot_etadiskr(morph(1:lenmorph),filter(1:lenfilter))
c         print*,'etadisk test a'
c         print*,etadisk
         call plot_etadiskz(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk1r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk1z(morph(1:lenmorph),filter(1:lenfilter))
         endif
c         print*,'etadisk test b'
c         print*,etadisk
        if  (morph(1:lenmorph) .eq. 'td') then
         call plot_etadisk1r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_etadisk1z(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk2r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk2z(morph(1:lenmorph),filter(1:lenfilter))

        endif
c         call plot_taudiskr(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudiskz(morph(1:lenmorph),filter(1:lenfilter))
ccc JJT 13 NOV 17 ccc
c        write(6,*)'hs3'
c        write(6,*)hs3
c        write(6,*)'hs4'
c        write(6,*)hs4
...
c         write(6,*)'eta5'
c         write(6,*) eta5
        if  (morph(1:lenmorph) .eq. 'di') then
         call plot_etadisk3r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_etadisk3z(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk3r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk3z(morph(1:lenmorph),filter(1:lenfilter))

        endif
        if  (morph(1:lenmorph) .eq. 'tdi') then
         call plot_etadisk4r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_etadisk4z(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk4r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk4z(morph(1:lenmorph),filter(1:lenfilter))

        endif
        if  (morph(1:lenmorph) .eq. 'do') then
         call plot_etadisk5r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_etadisk5z(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk5r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk5z(morph(1:lenmorph),filter(1:lenfilter))
        endif
        if  (morph(1:lenmorph) .eq. 'tdo') then
         call plot_etadisk6r(morph(1:lenmorph),filter(1:lenfilter))
c         print*,'etadisk6 test a'
c         print*,etadisk6
         call plot_etadisk6z(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk6r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudisk6z(morph(1:lenmorph),filter(1:lenfilter))
        endif
c         print*,'etadisk6 test b'
c         print*,etadisk6
ccc JJT 3 AUG 18 ccc
        if  (morph(1:lenmorph) .eq. 'ntd') then
         call plot_etadisk7r(morph(1:lenmorph),filter(1:lenfilter))
         call plot_etadisk7z(morph(1:lenmorph),filter(1:lenfilter))
        endif
c         print*,'etadisk7 test b'
c         print*,etadisk7
ccc JJT 13 DEC 17 ccc
         call plot_taudiskr(morph(1:lenmorph),filter(1:lenfilter))
         call plot_taudiskz(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk1r(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk1z(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk2r(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk2z(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk3r(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk3z(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk4r(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk4z(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk5r(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk5z(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk6r(morph(1:lenmorph),filter(1:lenfilter))
c         call plot_taudisk6z(morph(1:lenmorph),filter(1:lenfilter))
       endif
...
c
 999    continue
	close (unit=13)
!JJT commented out 19FEB19
!        if(idust .eq. 2)then
!         do 923 iy=1,ny
c         write(4,*)(dustplo(iy,k),k=1,nx)
! 923     continue
!        endif
...
c       1st disk and all other structure except 2nd disk        
        sigtruncate=shad*rtrund
        rplane=sqrt(x*x+y*y+z*z)
        truncate=0.5*(1.0-derf((rplane-rtrund)/sigtruncate))
        sigtruncate1=shad1*rtrund1
        truncate1=0.5*(1.0-derf((rplane-rtrund1)/sigtruncate1))

ccc JJT 14MAR18 ccc
c truncations
c inner disk
        sigtruncate3=shad3*rtrund3
        truncate3=0.5*(1.0-derf((rplane-rtrund3)/sigtruncate3))
c inner tdisk
        sigtruncate4=shad4*rtrund4
        truncate4=0.5*(1.0-derf((rplane-rtrund4)/sigtruncate4))
c outer disk
        sigtruncate5=shad5*rtrund5
        truncate5=0.5*(1.0-derf((rplane-rtrund5)/sigtruncate5))
c outer tdisk
        sigtruncate6=shad6*rtrund6
        truncate6=0.5*(1.0-derf((rplane-rtrund6)/sigtruncate6))
ccc JJT 14MAR18 ccc
...
c flared disk for the second (young) dust disk
        ...
        if(idisk1 .eq. 1) then
         if (Rho .lt. hdin) then
          adum = a0 * (zd/zd01)*
     >     ((rho/hdin) * (1. - xid0) + xid0) *
     >     dexp(-hdin/hd- dabs(z)/zd01) 
         endif
         if (Rho .ge. hdin) then
          adum = a0 * (zd/zd01)*
     >     dexp(-rho/hd- dabs(z)/zd01)
         endif
        endif
...
c double exponential disk
        if(idisk2 .eq. 1) then
         if (Rho .lt. hd1in) then
          adum1 = truncate1* a1 * (zd1/zd11)*
     >     ((rho/hd1in) * (1. - xid1) + xid1) *
     >     dexp(-hd1in/hd1- dabs(z)/zd11) 
         endif
         if (Rho .ge. hd1in) then
          adum1 = truncate1*a1*
...
c spiral arm
        if(idisk2 .eq. 2) then
         adum1 = truncate1*aarm(rho)*(zd1/zd11)*
     >   dexp(-dabs(z)/zd11)
        endif
...
ccc JJT 3 October 2017 ccc
c INNER COMPONENTS
c flared disk for the inner dust disk (3rd dust disk)
         zd31 = zd3
         if (zd3in .gt. zd3) then
          flared31 = dlog10((zd3solar - zd3)/(zd3in - zd3))
         else 
          flared31 = 0.
         endif
         if (hd3in .gt. 0.) then 
          flared32 = dlog10(hd3solar/hd3in)
          flared30 = flared31/flared32
         else
          flared30 = 0.
         endif
         if (zd3in .gt. zd3) then
          zd31 = zd3 + (zd3in - zd3) * (rho/hd3in)**flared30
         else
          zd31 = zd3
         endif

c flared disk for the inner thin dust disk (4th dust disk)
         zd41 = zd4
         if (zd4in .gt. zd4) then
          flared41 = dlog10((zd4solar - zd4)/(zd4in - zd4))
         else 
          flared41 = 0.
         endif
         if (hd4in .gt. 0.) then
          flared42 = dlog10(hd4solar/hd4in)
          flared41 = flared41/flared42
         else
          flared41 = 0.
         endif
         if (zd4in .gt. zd4) then
          zd41 = zd4 + (zd4in - zd4) * (rho/hd4in)**flared41
         else
          zd41 = zd4
         endif

        if(idisk3 .eq. 1) then
         if (Rho .lt. hd3in) then
          adum3 = a3 * (zd3/zd31)*
     >     ((rho/hd3in) * (1. - xid3) + xid3) *
     >     dexp(-hd3in/hd3- dabs(z)/zd31) 
         endif
         if (Rho .ge. hd3in) then
          adum3 = a3 * (zd3/zd31)*
     >     dexp(-rho/hd3- dabs(z)/zd31)
         endif
        endif

c  sech2 vertical distribution        
        if(idisk3 .eq. 3) then
         sechd31=1.d0/cosh(dabs(z)/zd31)
   	 sechd32=sechd31*sechd31
         if (Rho .lt. hd3in) then
          adum3 = a3 * (zd3/zd31)*
     >     ((rho/hd3in) * (1. - xid3) + xid3) *
     >     dexp(-hd3in/hd3)*sechd32 
         endif
         if (Rho .ge. hd3in) then
          adum3 = a3 * (zd3/zd31)*
     >     dexp(-rho/hd3)*sechd32
         endif
        endif

        adum3=adum3*truncate3

c
c     young dust disk        
c double exponential disk
        if(idisk4 .eq. 1) then
         if (Rho .lt. hd4in) then
          adum4 = truncate4* a4 * (zd4/zd41)*
     >     ((rho/hd4in) * (1. - xid4) + xid4) *
     >     dexp(-hd4in/hd4- dabs(z)/zd41) 
         endif
         if (Rho .ge. hd4in) then
          adum4 = truncate4*a4*
     >    (zd4/zd41)*dexp(-rho/hd4- dabs(z)/zd41)
         endif
        endif

c spiral arm
        if(idisk4 .eq. 2) then
         adum4 = truncate4*aarm(rho)*(zd4/zd41)*
     >   dexp(-dabs(z)/zd41)
        endif

c sech2 vertical distribution
        if(idisk4 .eq. 3) then
	 sechd41=1.d0/cosh(dabs(z)/zd41)
	 sechd42=sechd41*sechd41
         if (Rho .lt. hd4in) then 
          adum4 = truncate4* a4 * (zd4/zd41)*
     >     ((rho/hd4in) * (1. - xid4) + xid4) *
     >     dexp(-hd4in/hd4)*sechd42 

         endif
         if (Rho .ge. hd4in) then
          adum4 = truncate4*a4*
     >    (zd4/zd41)*dexp(-rho/hd4)*sechd42
         endif
        endif


c OUTER COMPONENTS
c flared disk for the inner dust disk (5th dust disk)
         zd51 = zd5
         if (zd5in .gt. zd5) then
          flared51 = dlog10((zd5solar - zd5)/(zd5in - zd5))
         else 
          flared51 = 0.
         endif
         if (hd5in .gt. 0.) then 
          flared52 = dlog10(hd5solar/hd5in)
          flared50 = flared51/flared52
         else
          flared50 = 0.
         endif
         if (zd5in .gt. zd5) then
          zd51 = zd5 + (zd5in - zd5) * (rho/hd5in)**flared50
         else
          zd51 = zd5
         endif
...
c flared disk for the inner thin dust disk (4th dust disk)
         zd61 = zd6
         if (zd6in .gt. zd6) then
          flared61 = dlog10((zd6solar - zd6)/(zd6in - zd6))
         else 
          flared61 = 0.
         endif
         if (hd6in .gt. 0.) then
          flared62 = dlog10(hd6solar/hd6in)
          flared61 = flared61/flared62
         else
          flared61 = 0.
         endif
         if (zd6in .gt. zd6) then
          zd61 = zd6 + (zd6in - zd6) * (rho/hd6in)**flared61
         else
          zd61 = zd6
         endif

        if(idisk5 .eq. 1) then
         if (Rho .lt. hd5in) then
          adum5 = a5 * (zd5/zd51)*
     >     ((rho/hd5in) * (1. - xid5) + xid5) *
     >     dexp(-hd5in/hd5- dabs(z)/zd51) 
         endif
         if (Rho .ge. hd5in) then
          adum5 = a5 * (zd5/zd51)*
     >     dexp(-rho/hd5- dabs(z)/zd51)
         endif
        endif

c  sech2 vertical distribution        
        if(idisk5 .eq. 3) then
         sechd51=1.d0/cosh(dabs(z)/zd51)
   	 sechd32=sechd51*sechd51
         if (Rho .lt. hd5in) then
          adum5 = a5 * (zd5/zd51)*
     >     ((rho/hd5in) * (1. - xid5) + xid5) *
     >     dexp(-hd5in/hd5)*sechd52 
         endif
         if (Rho .ge. hd5in) then
          adum5 = a5 * (zd5/zd51)*
     >     dexp(-rho/hd5)*sechd52
         endif
        endif

        adum5=adum5*truncate5

c
c     young dust disk        
c double exponential disk
        if(idisk6 .eq. 1) then
         if (Rho .lt. hd6in) then
          adum6 = truncate6* a6 * (zd6/zd61)*
     >     ((rho/hd6in) * (1. - xid6) + xid6) *
     >     dexp(-hd6in/hd6- dabs(z)/zd61) 
         endif
         if (Rho .ge. hd6in) then
          adum6 = truncate6*a6*
     >    (zd6/zd61)*dexp(-rho/hd6- dabs(z)/zd61)
         endif
        endif

c spiral arm
        if(idisk6 .eq. 2) then
         adum6 = truncate6*aarm(rho)*(zd6/zd61)*
     >   dexp(-dabs(z)/zd61)
        endif

c sech2 vertical distribution
        if(idisk6 .eq. 3) then
	 sechd61=1.d0/cosh(dabs(z)/zd61)
	 sechd62=sechd61*sechd61
         if (Rho .lt. hd6in) then 
          adum6 = truncate6* a6 * (zd6/zd61)*
     >     ((rho/hd6in) * (1. - xid6) + xid6) *
     >     dexp(-hd6in/hd6)*sechd62 

         endif
         if (Rho .ge. hd6in) then
          adum6 = truncate6*a6*
     >    (zd6/zd61)*dexp(-rho/hd6)*sechd62
         endif
        endif

ccc JJT 3 October 2017

ccc JJT edit - 4 September 17 ccc
c Set negative values in dust equal to 0 and add two dust disks together
c Calculations for young dust disk have been set to be stored as adum1
c and the addition of adum has been removed from the calculation
c (eg old style was adum = adum + truncate1*a1*...
c  new style is adum1 = truncate1*a1*...)   
c NB: No change has been made to the elliptical exponential disk


c JJT 23 Nov 17
c Edited to add inner truncation
        if (Rho .lt. hdtin) then
         adum = 0.
        endif

        if (Rho .lt. hd1tin) then
         adum1 = 0.
        endif
 
        if (Rho .lt. hd3tin) then
         adum3 = 0.
        endif
 
        if (Rho .lt. hd4tin) then
         adum4 = 0.
        endif
 
        if (Rho .lt. hd5tin) then
         adum5 = 0.
        endif 

        if (Rho .lt. hd6tin) then
         adum6 = 0.
        endif
...
c JJT 3 October 2017 ccc
c If extra dust disks are less than 0 set to 0
c inner Old dust disk
        if(adum3 .lt. 0) then
         adum3 = 0.
        endif

c inner Young dust disk
        if(adum4 .lt. 0) then
         adum4 = 0.         
        endif
c outer Old dust disk
        if(adum5 .lt. 0) then
         adum5 = 0.
        endif

c outer Young dust disk
        if(adum6 .lt. 0) then
         adum6 = 0.         
        endif

c Add all disks
        a = adum + adum1 + adum3 + adum4 + adum5 + adum6
ccc JJT 3 October 2017 ccc
ccc end JJT edit ccc
...
c	Space distribution of stars (see eq. 12)
	...
	common/param/zs,zd,hs,hd,d,rhomax,hdin,hsin,
     >   zsin,zssolar,hssolar,zdin,zdsolar,hdsolar,
     >   xis0,xid0,hstin,hdtin
c     >   flares01,flares02,flares00,zs01,sech02,
c     >   etadisk0,etadisk1,etabulge,
c     >   flares11,flares12,zs11,sech12
	common/atte/a0,eta0,rtruncate,sharp,athresh,rtrun,sha,
     >   rtruncated,sharpd,rtrund,shad
	common/bulge/etab,reff,ellipt2,ellipt,nsersic,bsersic
        common/ferrers/etaf,af,bf,cf,thetaf,ctf,stf,iferrers
...
c        write(6,*)'truncate1'
c        write(6,*)truncate1
ccc JJT 3 October 17 ccc
c       3rd disk
        sigtruncate3=sha3*rtrun3
        truncate3=0.5*(1.0-derf((rplane-rtrun3)/sigtruncate3))
c        write(6,*)'truncate3'
c        write(6,*)truncate3
c       4th disk
        sigtruncate4=sha4*rtrun4
        truncate4=0.5*(1.0-derf((rplane-rtrun4)/sigtruncate4))
c        write(6,*)'truncate4'
c        write(6,*)truncate4
c       5th disk
        sigtruncate5=sha5*rtrun5
        truncate5=0.5*(1.0-derf((rplane-rtrun5)/sigtruncate5))
c       6th disk
        sigtruncate6=sha6*rtrun6
        truncate6=0.5*(1.0-derf((rplane-rtrun6)/sigtruncate6))
c        print*,'sha6'
c        print*,sha6
c        print*,'rtrun6'
c        print*,rtrun6
c        print*,'sigtruncate6'
c        print*,sigtruncate6
c        print*,'truncate6'
c        print*,truncate6
c       7th disk
        sigtruncate7=sha7*rtrun7
c        print*,'sha7'
c        print*,sha7
c        print*,'rtrun7'
c        print*,rtrun7
c        print*,'sigtruncate7'
c        print*,sigtruncate7
        truncate7=0.5*(1.0-derf((rplane-rtrun7)/sigtruncate7))
c        print*,'truncate7'
c        print*,truncate7
ccc JJT 3 October 17 ccc
...
c       double exponential disk
        if(idisk2 .eq. 1) then
         if (Rho .lt. hs1in) then
           etadisk1 = eta1 * (zs1/zs11) * 
     >     ((rho/hs1in) * (1. - xis1) + xis1) * 
     >     dexp(-hs1in/hs1-dabs(z)/zs11)
         endif
         if (Rho .ge. hs1in) then
          etadisk1 = eta1 * (zs1/zs11) *
     >     dexp(-rho/hs1- dabs(z)/zs11)
         endif
        endif
...
ccc JJT 3 October 2017
c INNER COMPONENT
c       flared disk for the 3rd (inner old) stellar disk
       zs31 = zs3
         if (zs3in .gt. zs3) then
          flares31 = dlog10((zs3solar - zs3)/(zs3in - zs3))
         else 
          flares31 = 0.
         endif
         if (hs3in .gt. 0.) then 
          flares32 = dlog10(hs3solar/hs3in)
          flares30 = flares31/flares32
         else
          flares30 = 0.
         endif
         if (zs3in .gt. zs3) then
          zs31 = zs3 + (zs3in - zs3) * (rho/hs3in)**flares30
         else 
          zs31 = zs3
         endif
c       flared disk for the 4th (inner young) stellar disk
         zs41 = zs4
         if (zs4in .gt. zs4) then
          flares41 = dlog10((zs4solar - zs4)/(zs4in - zs4))
         else 
          flares41 = 0.
         endif
         if (hs4in .gt. 0.) then
          flares42 = dlog10(hs4solar/hs4in)
          flares40 = flares41/flares42
         else
          flares40 = 0.
         endif
         if (zs4in .gt. zs4) then
          zs41 = zs4 + (zs4in - zs4) * (rho/hs4in)**flares40
         else
          zs41 = zs4
         endif
c
...
c        write(6,*)'flares40'
c        write(6,*)flares40 
       if(idisk3 .eq. 0) then etadisk3=0.

c        write(6,*)idisk3
c       double exponential disks
        if(idisk3 .eq. 1) then
         if (Rho .lt. hs3in) then
          etadisk3 = eta3 * (zs/zs31) * 
     >     ((rho/hs3in) * (1. - xis3) + xis3) * 
     >     dexp(-hs3in/hs3-dabs(z)/zs31)
         endif
         if (Rho .ge. hs3in) then         
          etadisk3= eta3* (zs3/zs31) * 
     >     dexp(-rho/hs3- dabs(z)/zs31) 
         endif
        endif       
...
c       sech2 vertical distribution
        if(idisk3 .eq. 3) then
         sech31=1.d0/cosh(dabs(z)/zs31)
   	 sech32=sech31*sech31
         if (Rho .lt. hs3in) then
          etadisk3 = eta3 * (zs3/zs31) * 
     >     ((rho/hs3in) * (1. - xis3) + xis3) * 
     >     dexp(-hs3in/hs3)*sech32
         endif
         if (Rho .ge. hs3in) then
           etadisk3= eta3 * (zs3/zs31) * 
     >      dexp(-rho/hs3)*sech32
        ...
        if(idisk4 .eq. 0) then etadisk4=0.

c       double exponential disk
        if(idisk4 .eq. 1) then
         if (Rho .lt. hs4in) then
           etadisk4 = eta4 * (zs4/zs41) * 
     >     ((rho/hs4in) * (1. - xis4) + xis4) * 
     >     dexp(-hs4in/hs4-dabs(z)/zs41)
         endif
         if (Rho .ge. hs4in) then
          etadisk4 = eta4 * (zs4/zs41) *
     >     dexp(-rho/hs4- dabs(z)/zs41)
         endif
        endif
...
c spiral arm radial distribution
        if(idisk4 .eq. 2) then      
          etadisk4= etaarm(rho) * 
     >     (zs4/zs41) * dexp(-dabs(z)/zs41)
        endif

c   sech2 vertical distribution
        if(idisk4 .eq. 3) then
	 sech41=1.d0/cosh(dabs(z)/zs41)
	 sech42=sech41*sech41
         if (Rho .lt. hs4in) then     
          etadisk4 = eta4 * (zs4/zs41) * 
     >     ((rho/hs4in) * (1. - xis4) + xis4) * 
     >     dexp(-hs4in/hs4)*sech42  
         endif
         if (Rho .ge. hs4in) then
          etadisk4=eta4* (zs4/zs41)*
     >     dexp(-rho/hs4)*sech42
...
c OUTER COMPONENT
c       flared disk for the 5th (outer old) stellar disk
       zs51 = zs5
         if (zs5in .gt. zs5) then
          flares51 = dlog10((zs5solar - zs5)/(zs5in - zs5))
         else 
          flares51 = 0.
         endif
         if (hs5in .gt. 0.) then 
          flares52 = dlog10(hs5solar/hs5in)
          flares50 = flares51/flares52
         else
          flares50 = 0.
         endif
         if (zs5in .gt. zs5) then
          zs51 = zs5 + (zs5in - zs5) * (rho/hs5in)**flares50
         else 
          zs51 = zs5
         endif
c       flared disk for the 6th (outer young) stellar disk
         zs61 = zs6
         if (zs6in .gt. zs6) then
          flares61 = dlog10((zs6solar - zs6)/(zs6in - zs6))
         else 
          flares61 = 0.
         endif
         if (hs6in .gt. 0.) then
          flares62 = dlog10(hs6solar/hs6in)
          flares60 = flares61/flares62
         else
          flares60 = 0.
         endif
         if (zs6in .gt. zs6) then
          zs61 = zs6 + (zs6in - zs6) * (rho/hs6in)**flares60
         else
          zs61 = zs6
         endif
c
        if(idisk5 .eq. 0) then etadisk5=0.

c       double exponential disks
        if(idisk5 .eq. 1) then
         if (Rho .lt. hs5in) then
          etadisk5 = eta5 * (zs5/zs51) * 
     >     ((rho/hs5in) * (1. - xis5) + xis5) * 
     >     dexp(-hs5in/hs5-dabs(z)/zs51)
         endif
         if (Rho .ge. hs5in) then         
          etadisk5= eta5* (zs5/zs51) * 
     >     dexp(-rho/hs5- dabs(z)/zs51) 
         endif
        endif       
c       constant emissivity to test energy densities
c        etadisk0= eta0*dfloat(idisk1)
...
c       sech2 vertical distribution
        if(idisk5 .eq. 3) then
         sech51=1.d0/cosh(dabs(z)/zs51)
   	 sech52=sech51*sech51

         if (Rho .lt. hs5in) then
          etadisk5 = eta5 * (zs5/zs51) * 
     >     ((rho/hs5in) * (1. - xis5) + xis5) * 
     >     dexp(-hs5in/hs5)*sech52
         endif
         if (Rho .ge. hs5in) then
           etadisk5= eta5 * (zs5/zs51) * 
     >      dexp(-rho/hs5)*sech52
        ...
        if(idisk6 .eq. 0) then etadisk6=0.

c       double exponential disk
        if(idisk6 .eq. 1) then
         if (Rho .lt. hs6in) then
           etadisk6 = eta6 * (zs6/zs61) * 
     >     ((rho/hs6in) * (1. - xis6) + xis6) * 
     >     dexp(-hs6in/hs6-dabs(z)/zs61)
         endif
         if (Rho .ge. hs6in) then
          etadisk6 = eta6 * (zs6/zs61) *
     >     dexp(-rho/hs6- dabs(z)/zs61)
         endif
        endif
...
c spiral arm radial distribution
        if(idisk6 .eq. 2) then      
          etadisk6= etaarm(rho) * 
     >     (zs6/zs61) * dexp(-dabs(z)/zs61)
        endif

c   sech2 vertical distribution
        if(idisk6 .eq. 3) then
	 sech61=1.d0/cosh(dabs(z)/zs61)
	 sech62=sech61*sech61
         if (Rho .lt. hs6in) then     
          etadisk6 = eta6 * (zs6/zs61) * 
     >     ((rho/hs6in) * (1. - xis6) + xis6) * 
     >     dexp(-hs6in/hs6)*sech62  
         endif
         if (Rho .ge. hs6in) then
          etadisk6=eta6* (zs6/zs61)*
     >     dexp(-rho/hs6)*sech62
...
c Nuclear COMPONENT
c       flared disk for the 7th (nuclear young) stellar disk
         zs71 = zs7
         if (zs7in .gt. zs7) then
          flares71 = dlog10((zs7solar - zs7)/(zs7in - zs7))
         else 
          flares71 = 0.
         endif
         if (hs7in .gt. 0.) then
          flares72 = dlog10(hs7solar/hs7in)
          flares70 = flares71/flares72
         else
          flares70 = 0.
         endif
         if (zs7in .gt. zs7) then
          zs71 = zs7 + (zs7in - zs7) * (rho/hs7in)**flares70
         else
          zs71 = zs7
         endif
c
c        print*,'idisk7'
c        print*,idisk7
        if(idisk7 .eq. 0) then etadisk7=0.

c       double exponential disk
        if(idisk7 .eq. 1) then
         if (Rho .lt. hs7in) then
           etadisk7 = eta7 * (zs7/zs71) * 
     >     ((rho/hs7in) * (1. - xis7) + xis7) * 
     >     dexp(-hs7in/hs7-dabs(z)/zs71)
         endif
         if (Rho .ge. hs7in) then
          etadisk7 = eta7 * (zs7/zs71) *
     >     dexp(-rho/hs7- dabs(z)/zs71)
         endif
        endif
...
c spiral arm radial distribution
        if(idisk7 .eq. 2) then      
          etadisk7= etaarm(rho) * 
     >     (zs7/zs71) * dexp(-dabs(z)/zs71)
        endif

c   sech2 vertical distribution
        if(idisk7 .eq. 3) then
	 sech71=1.d0/cosh(dabs(z)/zs71)
	 sech72=sech71*sech71
         if (Rho .lt. hs7in) then     
          etadisk7 = eta7 * (zs7/zs71) * 
     >     ((rho/hs7in) * (1. - xis7) + xis7) * 
     >     dexp(-hs7in/hs7)*sech72  
         endif
         if (Rho .ge. hs7in) then
          etadisk7=eta7* (zs7/zs71)*
     >     dexp(-rho/hs7)*sech72
...
ccc JJT 3 October 17              
        etadisk0=etadisk0*truncate
        etadisk1=etadisk1*truncate1
ccc JJT 3 October 17 ccc
c truncated extra disks
        etadisk3=etadisk3*truncate3
c        write(6,*)etadisk3
        etadisk4=etadisk4*truncate4
        etadisk5=etadisk5*truncate5
        etadisk6=etadisk6*truncate6
c         print*,'etadisk6'
c         print*,etadisk6
ccc JJT 3 October 17 ccc
ccc JJT 3 Aug 18 ccc      
        etadisk7=etadisk7*truncate7
c         print*,'etadisk7'
c         print*,etadisk7
c        print*,etadisk7
ccc JJT edit - 4 September 17 ccc
c Set negative stellar emissivity values to zero

c JJY 23 Nov 17
c added inner truncation radius
        if(Rho .lt. hstin) then
         etadisk0=0
        endif

        if(Rho .lt. hs1tin) then
         etadisk1=0
        endif

        if(Rho .lt. hs3tin) then
         etadisk3=0
        endif

        if(Rho .lt. hs4tin) then
         etadisk4=0
        endif
c        print*,'hs5tin'
c        print*,hs5tin
        if(Rho .lt. hs5tin) then
         etadisk5=0
        endif

        if(Rho .lt. hs6tin) then
         etadisk6=0
        endif

        if(Rho .lt. hs7tin) then
         etadisk7=0
        endif


c First stellar disk
        if(etadisk0 .lt. 0) then
         etadisk0 = 0.
        endif
c Second stellar disk
        if(etadisk1 .lt. 0) then
         etadisk1 = 0.
        endif       

ccc JJT 3 October 17 ccc
c 3rd stellar disk
        if(etadisk3 .lt. 0) then
         etadisk3 = 0.
        endif
c 4th stellar disk
        if(etadisk4 .lt. 0) then
         etadisk4 = 0.
        endif 
c 5th stellar disk
        if(etadisk5 .lt. 0) then
         etadisk5 = 0.
        endif
c 6th stellar disk
        if(etadisk6 .lt. 0) then
         etadisk6 = 0.
        endif 

c 7th stellar disk
        if(etadisk7 .lt. 0) then
         etadisk7 = 0.
        endif 
ccc JJT 3 October 17 ccc
ccc end JJT edit ccc
...
ccc JJT 3 October 17 ccc
c	eta= etadisk0+etabulge+etadisk1+etaferrers+etaellexp
       eta = etadisk0 + etabulge + etadisk1 + etaferrers + etaellexp +
     >  etadisk3 + etadisk4 + etadisk5 + etadisk6 + etadisk7
ccc JJT 3 October 17 ccc
...
c     r z u fa
c      open (unit=14,file='dust.urad')
c     r z iang fv
c      open (unit=15,file='dust.fvec')
c     u
c      open (unit=16,file='dust.ur')
c     fa
c      open (unit=17,file='dust.abs')
c     f1
c      open (unit=18,file='dust.sca')
...
c
        ...
        if(ifilter.eq.16)xlam=36000.
        if(ifilter.eq.17)xlam=45000.
        if(ifilter.eq.18)xlam=58000.

        nradtot=nr*nz
c        write(14,*)nradtot,nr,nz,ifilter,xlam
c       no header to unit 16 as this is intended 
c       for display using plotresult.pro
c        write(16,*)nradtot,nr,nz,ifilter,xlam
c        write(17,*)nradtot,nr,nz,ifilter,xlam
c        write(18,*)nradtot,nr,nz,ifilter,xlam
      do 100 ir=1,nr
...
c output y,z in units of 100pc    
        yout(ii)=y*pix2kpc*1000.0
        zout(ii)=z*pix2kpc*1000.0
...
c        factor=1.41106d58
        ...
        uout(ii)=u(ii)*factor
        faout(ii)=fa(ii)*factor
c        write(14,275) yout,zout,uout,faout
...
c
c      write(6,892)
c 892  format(1h ,'r z u_rad u_abs written to dust.urad')
c      write(6,893)
c 893  format(1h ,'r z iang f_vec  written to dust.fvec')
c      write(6,894)
c 894  format(1h ,'u_rad written to dust.ur')
c      write(6,895)
c 895  format(1h ,'f_abs written to dust.abs')
c      write(6,896)
c 896  format(1h ,'f_1 written to dust.sca')
c
 999  continue
c
      fs0=fs0_in
...
c
      ...
      subroutine plot_etabulger(morph,filter)
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=15, file='../out/profiles/bulgeplotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
...
c
      ...
      subroutine plot_etabulgez(morph,filter)
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=16, file='../out/profiles/bulgeplotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
...
cc disk emissivity
      ...
      subroutine plot_etadiskr(morph,filter)
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      lenmorph=len_trim(trim(morph))
      morph=morph(1:lenmorph)
c     >   flares01,flares02,flares00,zs01,
c     >   sech02,etadisk0,etadisk1,etabulge,
c     >   flares11,flares12,zs11,sech12

      open (unit=19, file='../out/profiles/diskplotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
...
c plot from 0 to 11 * reff sampled at 0.01*reff
 ...
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hs/step
c      nstep=100+rtrun/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(19,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
       etaplot=eta(x,y,z)
       yout=y * pix2kpc
c       if (istep .eq. 1) write(6,*) zs, zsin,
c     >  dlog10((zssolar - zs)/(zsin - zs)),
c     > flares01,flares02,flares00,zs01,
c     > sech02,eta0,etadisk0,etadisk1,etabulge,etaplot
...
c
      ...
      subroutine plot_etadiskz(morph,filter)
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=20, file='../out/profiles/diskplotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open diskplotz.dat')
      ...
      etab=0.0
c 
      write(6,78) zs,pix2kpc
 78   format(1h,'zs,pix2kpc=',2f8.2)
      step=0.01 !zs*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
cc disk emissivity
      ...
      subroutine plot_etadisk1r(morph,filter)
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      lenmorph=len_trim(trim(morph))
      morph=morph(1:lenmorph)
      open (unit=23, file='../out/profiles/disk1plotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
...
c plot from 0 to 11 * reff sampled at 0.01*reff
 ...
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hs1/step
c       nstep=100+rtrun1/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(23,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
c
      ...
      subroutine plot_etadisk1z(morph,filter)
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      lenmorph=len_trim(trim(morph))
      morph=morph(1:lenmorph)
      open (unit=24, file='../out/profiles/disk1plotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
...
cc dust disk opacity
      ...
      subroutine plot_taudisk1r(morph,filter)
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=21, file='../out/profiles/disk1tauplotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk1tauplotr.dat')
      x=0.0
      z=0.0
      a3_in=a3
      a3=0.0
...
c plot from 0 to 11 * reff sampled at 0.01*reff
 ...
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hd/step
c       nstep=100+rtrund/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(21,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=21)
      write(6,222)
 222  format('close disk1tauplotr.dat')
c
      return
      end

      subroutine plot_taudisk1z(morph,filter)
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=22, file='../out/profiles/disk1tauplotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk1tauplotz.dat')
      x=0.0
      y=0.0
      a3_in=a3
      a3=0.0
...
234   continue
      ...
      close (unit=22)
      write(6,222)
 222  format('close disk1tauplotz.dat')
c
      return
      end
...
cc disk 3 emissivity

      subroutine plot_etadisk3r(morph,filter)
c
c plots a radial profile of disk emissivity and writes
c to a file
c
...
c     >   flares11,flares12,zs11,sech12
      ...
      open (unit=30, file='../out/profiles/disk3plotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk3plotr.dat')
      x=0.0
      z=0.0
      eta1_in=eta1
      eta1=0.0
      ...
      etab=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hs3,pix2kpc
 78   format(1h,'hs3,pix2kpc=',2f8.2)
      step=0.010 !s3*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hs3/step
c       nstep=100+rtrun3/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(30,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=30)
      write(6,222)
 222  format('close disk3plotr.dat')
c
      return
      end

      subroutine plot_etadisk3z(morph,filter)
c
c plots a vertical profile of disk emissivity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=31, file='../out/profiles/disk3plotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk3plotz.dat')
      x=0.0
      y=0.0
      eta1_in=eta1
      eta1=0.0
      ...
      etab=0.0
c 
      write(6,78) zs3,pix2kpc
 78   format(1h,'zs3,pix2kpc=',2f8.2)
      step=0.01 !zs3*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=31)
      write(6,222)
 222  format('close disk3plotz.dat')
      return
      end

c thin disk 4 emissivity
cc disk 4 emissivity

      subroutine plot_etadisk4r(morph,filter)
c
c plots a radial profile of thin disk 4 emissivity and writes
c to a file
c
	implicit real*8 (a-h, o-z)
	character*80 morph,filter
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=40, file='../out/profiles/disk4plotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk4plotr.dat')
      x=0.0
      z=0.0
      eta0_in=eta0
      eta0=0.0
      ...
      etab=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hs4,pix2kpc
 78   format(1h,'hs4,pix2kpc=',2f8.2)
      step=0.010 !s4*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hs4/step
c       nstep=100+rtrun4/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(40,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=40)
      write(6,222)
 222  format('close disk4plotr.dat')
c
      return
      end

      subroutine plot_etadisk4z(morph,filter)
c
c plots a vertical profile of thin disk 4 emissivity and writes
c to a file
c
	implicit real*8 (a-h, o-z)
	character*80 morph,filter
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=41, file='../out/profiles/disk4plotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk4plotz.dat')
      x=0.0
      y=0.0
      eta0_in=eta0
      eta0=0.0
      ...
      etab=0.0
c 
      write(6,78) zs4,pix2kpc
 78   format(1h,'zs4,pix2kpc=',2f8.2)
      step=0.01 !zs4*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=41)
      write(6,222)
 222  format('close disk4plotz.dat')
c
      return
      end

cc disk 5 emissivity

      subroutine plot_etadisk5r(morph,filter)
c
c plots a radial profile of disk 5 emissivity and writes
c to a file
c
	implicit real*8 (a-h, o-z)
	character*80 morph,filter
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=50, file='../out/profiles/disk5plotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk5plotr.dat')
      x=0.0
      z=0.0
      eta0_in=eta0
      eta0=0.0
      ...
      etab=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hs5,pix2kpc
 78   format(1h,'hs5,pix2kpc=',2f8.2)
      step=0.010 !s5*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hs5/step
c       nstep=100+rtrun5/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(50,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=50)
      write(6,222)
 222  format('close disk5plotr.dat')
c
      return
      end

      subroutine plot_etadisk5z(morph,filter)
c
c plots a vertical profile of disk 5 emissivity and writes
c to a file
c
	implicit real*8 (a-h, o-z)
	character*80 morph,filter
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=51, file='../out/profiles/disk5plotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk5plotz.dat')
      x=0.0
      y=0.0
      eta0_in=eta0
      eta0=0.0
      ...
      etab=0.0
c 
      write(6,78) zs5,pix2kpc
 78   format(1h,'zs5,pix2kpc=',2f8.2)
      step=0.01 !zs5*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=51)
      write(6,222)
 222  format('close disk5plotz.dat')
c
      return
      end

c thin disk 6 emissivity
cc disk 6 emissivity

      subroutine plot_etadisk6r(morph,filter)
c
c plots a radial profile of thin disk 6 emissivity and writes
c to a file
c
	implicit real*8 (a-h, o-z)
	character*80 morph,filter
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      print*,'eta6'
      print*,eta6
      open (unit=60, file='../out/profiles/disk6plotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk6plotr.dat')
c      print*,eta6
      x=0.0
      z=0.0
      eta0_in=eta0
...
c      print*,eta7_in
      ...
      etab=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hs6,pix2kpc
 78   format(1h,'hs6,pix2kpc=',2f8.2)
      step=0.010 !s6*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hs6/step
c       nstep=100+rtrun6/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(60,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=60)
      write(6,222)
 222  format('close disk6plotr.dat')
c
      return
      end

      subroutine plot_etadisk6z(morph,filter)
c
c plots a vertical profile of thin disk 6 emissivity and writes
c to a file
c
	implicit real*8 (a-h, o-z)
	character*80 morph,filter
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      print*,'eta6'
      print*,eta6
      open (unit=61, file='../out/profiles/disk6plotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk6plotz.dat')
      x=0.0
      y=0.0
      eta0_in=eta0
      eta0=0.0
      ...
      etab=0.0
c 
      write(6,78) zs6,pix2kpc
 78   format(1h,'zs6,pix2kpc=',2f8.2)
      step=0.01 !zs6*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=61)
      write(6,222)
 222  format('close disk6plotz.dat')
c
      return
      end
...
c thin disk 7 emissivity
cc disk 7 emissivity

      subroutine plot_etadisk7r(morph,filter)
c
c plots a radial profile of thin disk 7 emissivity and writes
c to a file
c
	implicit real*8 (a-h, o-z)
	character*80 morph,filter
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      print*,'eta7'
      print*,eta7
      open (unit=70, file='../out/profiles/disk7plotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk7plotr.dat')
      x=0.0
      z=0.0
      eta0_in=eta0
      eta0=0.0
      ...
      etab=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hs7,pix2kpc
 78   format(1h,'hs7,pix2kpc=',2f8.2)
      step=0.010 !s6*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=70)
      write(6,222)
 222  format('close disk7plotr.dat')
c
      return
      end

      subroutine plot_etadisk7z(morph,filter)
c
c plots a vertical profile of thin disk 6 emissivity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      print*,'eta7'
      print*,eta7
      open (unit=71, file='../out/profiles/disk7plotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk7plotz.dat')
      x=0.0
      y=0.0
      eta0_in=eta0
      eta0=0.0
      ...
      etab=0.0
c 
      write(6,78) zs7,pix2kpc
 78   format(1h,'zs7,pix2kpc=',2f8.2)
      step=0.01 !zs6*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=71)
      write(6,222)
 222  format('close disk7plotz.dat')
c
      return
      end
...
ccc 12DEC17 JJT
cc dust disk2 opacity

      subroutine plot_taudisk2r(morph,filter)
c
c plots a radial profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=21, file='../out/profiles/disk2tauplotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk2tauplotr.dat')
      x=0.0
      z=0.0
      a3_in=a3
      a3=0.0
      ...
      a6=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hd1,pix2kpc
 78   format(1h,'hd1,pix2kpc=',2f8.2)
      step=0.010 !d1*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hd1/step
c       nstep=100+rtrund1/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(21,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=21)
      write(6,222)
 222  format('close disk2tauplotr.dat')
c
      return
      end

      subroutine plot_taudisk2z(morph,filter)
c
c plots a vertical profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=22, file='../out/profiles/disk2tauplotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk2tauplotz.dat')
      x=0.0
      y=0.0
      a3_in=a3
      a3=0.0
      ...
      a6_in=a6
      a6=0.0
      write(6,78) zd1,pix2kpc
 78   format(1h,'zd1,pix2kpc=',2f8.2)
      step=0.01 !zd1*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=22)
      write(6,222)
 222  format('close disk2tauplotz.dat')
c
      return
      end

cc 3 dust disk opacity

      subroutine plot_taudisk3r(morph,filter)
c
c plots a radial profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=21, file='../out/profiles/disk3tauplotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk3tauplotr.dat')
      x=0.0
      z=0.0
      a0_in=a0
      a0=0.0
      ...
      a6=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hd3,pix2kpc
 78   format(1h,'hd3,pix2kpc=',2f8.2)
      step=0.010 !d3*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hd3/step
c       nstep=100+rtrund3/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(21,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=21)
      write(6,222)
 222  format('close disk3tauplotr.dat')
c
      return
      end

      subroutine plot_taudisk3z(morph,filter)
c
c plots a vertical profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=22, file='../out/profiles/disk3tauplotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk3tauplotz.dat')
      x=0.0
      y=0.0
      a0_in=a0
      a0=0.0
      ...
      a6_in=a6
      a6=0.0
      write(6,78) zd3,pix2kpc
 78   format(1h,'zd3,pix2kpc=',2f8.2)
      step=0.01 !zd3*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=22)
      write(6,222)
 222  format('close disk3tauplotz.dat')
c
      return
      end

cc 4 dust disk opacity

      subroutine plot_taudisk4r(morph,filter)
c
c plots a radial profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=21, file='../out/profiles/disk4tauplotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk4tauplotr.dat')
      x=0.0
      z=0.0
      a0_in=a0
      a0=0.0
      ...
      a6=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hd4,pix2kpc
 78   format(1h,'hd4,pix2kpc=',2f8.2)
      step=0.010 !d4*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hd4/step
c       nstep=100+rtrund4/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(21,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=21)
      write(6,222)
 222  format('close disk4tauplotr.dat')
c
      return
      end

      subroutine plot_taudisk4z(morph,filter)
c
c plots a vertical profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=22, file='../out/profiles/disk4tauplotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk4tauplotz.dat')
      x=0.0
      y=0.0
      a0_in=a0
      a0=0.0
      ...
      a6_in=a6
      a6=0.0
      write(6,78) zd4,pix2kpc
 78   format(1h,'zd4,pix2kpc=',2f8.2)
      step=0.01 !zd4*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=22)
      write(6,222)
 222  format('close disk4tauplotz.dat')
c
      return
      end

cc 5 dust disk opacity

      subroutine plot_taudisk5r(morph,filter)
c
c plots a radial profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=21, file='../out/profiles/disk5tauplotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk5tauplotr.dat')
      x=0.0
      z=0.0
      a0_in=a0
      a0=0.0
      ...
      a6=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hd5,pix2kpc
 78   format(1h,'hd5,pix2kpc=',2f8.2)
      step=0.010 !d5*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hd5/step
c       nstep=100+rtrund5/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(21,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=21)
      write(6,222)
 222  format('close disk5tauplotr.dat')
c
      return
      end

      subroutine plot_taudisk5z(morph,filter)
c
c plots a vertical profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=22, file='../out/profiles/disk5tauplotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk5tauplotz.dat')
      x=0.0
      y=0.0
      a0_in=a0
      a0=0.0
      ...
      a6_in=a6
      a6=0.0
      write(6,78) zd5,pix2kpc
 78   format(1h,'zd5,pix2kpc=',2f8.2)
      step=0.01 !zd5*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=22)
      write(6,222)
 222  format('close disk5tauplotz.dat')
c
      return
      end

cc 6 dust disk opacity

      subroutine plot_taudisk6r(morph,filter)
c
c plots a radial profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=21, file='../out/profiles/disk6tauplotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk6tauplotr.dat')
      x=0.0
      z=0.0
      a0_in=a0
      a0=0.0
      ...
      a4=0.0
c plot from 0 to 11 * reff sampled at 0.01*reff
      write(6,78) hd6,pix2kpc
 78   format(1h,'hd6,pix2kpc=',2f8.2)
      step=0.010 !d6*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
c      nstep=1+75. * hd6/step
c       nstep=100+rtrund6/step
       nstep=100+(prof_lim/pix2kpc)/step
      write(21,*)nstep
      do 234 istep=1,nstep 
       y=step*(float(istep)-1.0)
...
234   continue
      ...
      close (unit=21)
      write(6,222)
 222  format('close disk6tauplotr.dat')
c
      return
      end

      subroutine plot_taudisk6z(morph,filter)
c
c plots a vertical profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=22, file='../out/profiles/disk6tauplotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
 221  format('open disk6tauplotz.dat')
      x=0.0
      y=0.0
      a0_in=a0
      a0=0.0
      ...
      a4_in=a4
      a4=0.0
      write(6,78) zd6,pix2kpc
 78   format(1h,'zd6,pix2kpc=',2f8.2)
      step=0.01 !zd6*0.01
      write(6,79) step
 79   format(1h,'step',f8.4)
c      nstep=1+(7./pix2kpc)/step
...
234   continue
      ...
      close (unit=22)
      write(6,222)
 222  format('close disk6tauplotz.dat')
c
      return
      end

cc total dust disk opacity

      subroutine plot_taudiskr(morph,filter)
c
c plots a radial profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=21, file='../out/profiles/disktauplotr_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
...
c
      ...
      subroutine plot_taudiskz(morph,filter)
c
c plots a vertical profile of disk opacity and writes
c to a file
c
...
c nulear comp ( young stellar disc
	common/ntdisk7/eta7,zs7,hs7,a7,idisk7,
     ...
     >  eta7arm,a7arm,narm7,rup7,fillarm7
      ...
      open (unit=22, file='../out/profiles/disktauplotz_'//
     >  filter(1:lenfilter)//'.dat')
      write(6,221)
...
234   continue
      close (unit=22)
      write(6,222)
 222  format('close disktauplotz.dat')
c
