...
c       Decoupled the truncation radii of the dust and stellar disks.
        ...
        Subroutine dust_z(mask,dzmodel)
c----------------------------------------------------------------------------
...
c concerning the3 pixel limit see also zone2= 3.0+ ds0/reff in FSTEP
         ...
         call plot_etadisk1r
         call plot_etadisk1z
c         call plot_taudiskr
c         call plot_taudiskz
...
c         write(6,*)'eta5'
c         write(6,*) eta5
c         call plot_etadisk3r
c         call plot_etadisk3z
c         call plot_etadisk4r
c         call plot_etadisk4z
c         call plot_etadisk5r
c         call plot_etadisk5z
c         call plot_etadisk6r
c         call plot_etadisk6z
...
ccc JJT 13 DEC 17 ccc
         ...
         call plot_taudisk2r
         call plot_taudisk2z
c        call plot_taudisk3r
c        call plot_taudisk3z
c        call plot_taudisk4r
c        call plot_taudisk4z
c        call plot_taudisk5r
c        call plot_taudisk5z
c        call plot_taudisk6r
c        call plot_taudisk6z
...
c	eta= etadisk0+etabulge+etadisk1+etaferrers+etaellexp
     ...
     >  etadisk3 + etadisk4 + etadisk5 + etadisk6
ccc JJT 3 October 17 ccc
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=21, file='disk1tauplotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=22, file='disk1tauplotz.dat')
      write(6,221)
...
c     >   flares11,flares12,zs11,sech12
      ...
      open (unit=30, file='disk3plotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=31, file='disk3plotz.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=40, file='disk4plotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=41, file='disk4plotz.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=50, file='disk5plotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=51, file='disk5plotz.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=60, file='disk6plotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=61, file='disk6plotz.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=21, file='disk2tauplotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=22, file='disk2tauplotz.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=21, file='disk3tauplotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=22, file='disk3tauplotz.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=21, file='disk4tauplotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=22, file='disk4tauplotz.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=21, file='disk5tauplotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=22, file='disk5tauplotz.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=21, file='disk6tauplotr.dat')
      write(6,221)
...
c tdisk
	common/eoutdisk6/eta6,zs6,hs6,zd6,hd6,a6,tau6,idisk6,
     ...
     >   rtruncated6,sharpd6,rtrund6,shad6
      ...
      open (unit=22, file='disk6tauplotz.dat')
      write(6,221)
