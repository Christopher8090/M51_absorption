pro temp_trans_template,comp,model,qyear,qcomp_year,dim_size,aa,lu,ul,lambda_q,qq_abs,$
	tt_q,qp_grain,stau,suv,sold,sbd,dir,inclbigbang=inclbigbang,energy_abs,check, scaabs
